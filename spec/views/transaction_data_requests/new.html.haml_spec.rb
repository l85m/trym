...
describe "transaction_data_requests/new" do
  before(:each) do
    assign(:transaction_data_request, stub_model(TransactionDataRequest,
      :user => nil,
  ...
  it "renders new transaction_data_request form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", transaction_data_requests_path, "post" do
