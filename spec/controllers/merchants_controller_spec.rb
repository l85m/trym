  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved merchant as @merchant" do
        ...
        post :create, {:merchant => { "name" => "invalid value" }}, valid_session
        assigns(:merchant).should be_a_new(Merchant)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested merchant" do
        ...
        Merchant.any_instance.should_receive(:update).with({ "name" => "MyText" })
        put :update, {:id => merchant.to_param, :merchant => { "name" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the merchant as @merchant" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Merchant.any_instance.stub(:save).and_return(false)
        put :update, {:id => merchant.to_param, :merchant => { "name" => "invalid value" }}, valid_session
        assigns(:merchant).should eq(merchant)
      end
