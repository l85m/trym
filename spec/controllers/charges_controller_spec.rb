...
describe ChargesController do
  ...
  let(:valid_attributes) { { "merchant" => "MyText" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved charge as @charge" do
        ...
        post :create, {:charge => { "merchant" => "invalid value" }}, valid_session
        assigns(:charge).should be_a_new(Charge)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested charge" do
        ...
        Charge.any_instance.should_receive(:update).with({ "merchant" => "MyText" })
        put :update, {:id => charge.to_param, :charge => { "merchant" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the charge as @charge" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Charge.any_instance.stub(:save).and_return(false)
        put :update, {:id => charge.to_param, :charge => { "merchant" => "invalid value" }}, valid_session
        assigns(:charge).should eq(charge)
      end
